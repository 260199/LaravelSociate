...
<div class="container-fluid mb-4">
    ...
    <div class="row">
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="<?php echo e(url('daily')); ?>" style="text-decoration: none;">
                ...
                <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                Aktivitas</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($totalCount); ?></div>
                            </div>
                            <div class="col-auto">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow-mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text primary">Bar Chart Aktivitas <?php echo e($user->name); ?></h6>
                </div>
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-6">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <!-- Total -->
                    <div class="mb-3">
                        <h5>Total: <span id="totalCount"><?php echo e($totalCount); ?></span></h5>
                        <div class="progress mb-4">
                            <div class="progress-bar bg-secondary" role="progressbar"
                                 style="width: <?php echo e($totalCount > 0 ? 100 : 0); ?>%"
                                 aria-valuenow="<?php echo e($totalCount); ?>" aria-valuemin="0" aria-valuemax="100">
                    ...
                    <!-- Progress -->
                    <div class="mb-3">
                        <h5>Berlangsung: <span id="progressCount"><?php echo e($progressCount); ?></span></h5>
                        <div class="progress mb-4">
                            <div class="progress-bar" role="progressbar"
                                 style="width: <?php echo e($totalCount > 0 ? ($progressCount / $totalCount) * 100 : 0); ?>%"
                                 aria-valuenow="<?php echo e($progressCount); ?>" aria-valuemin="0" aria-valuemax="100">
                                <?php echo e($progressCount); ?> Progress
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Dilaporkan -->
                    <div class="mb-3">
                        <h5>Dilaporkan: <span id="dilaporkanCount"><?php echo e($dilaporkanCount); ?></span></h5>
                        <div class="progress mb-4">
                            <div class="progress-bar bg-info" role="progressbar"
                                 style="width: <?php echo e($totalCount > 0 ? ($dilaporkanCount / $totalCount) * 100 : 0); ?>%"
                                 aria-valuenow="<?php echo e($dilaporkanCount); ?>" aria-valuemin="0" aria-valuemax="100">
                                <?php echo e($dilaporkanCount); ?> Dilaporkan
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Diterima -->
                    <div class="mb-3">
                        <h5>Selesai: <span id="diterimaCount"><?php echo e($diterimaCount); ?></span></h5>
                        <div class="progress mb-4">
                            <div class="progress-bar bg-success" role="progressbar"
                                 style="width: <?php echo e($totalCount > 0 ? ($diterimaCount / $totalCount) * 100 : 0); ?>%"
                                 aria-valuenow="<?php echo e($diterimaCount); ?>" aria-valuemin="0" aria-valuemax="100">
                                <?php echo e($diterimaCount); ?> Diterima
                            </div>
                        </div>
                    </div>
...
let userBarChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [
            {
                label: 'Total',
                data: [<?php echo e($totalCount); ?>, 0, 0, 0], // Total count (first bar)
                backgroundColor: '#3498db',
                borderWidth: 1
            },
            {
                label: 'Progress',
                data: [0, <?php echo e($progressCount); ?>, 0, 0], // Progress count (second bar)
                backgroundColor: '#f1c40f',
                borderWidth: 1
            },
            {
                label: 'Dilaporkan',
                data: [0, 0, <?php echo e($dilaporkanCount); ?>, 0], // Dilaporkan count (third bar)
                backgroundColor: '#e67e22',
                borderWidth: 1
            },
            {
                label: 'Diterima',
                data: [0, 0, 0, <?php echo e($diterimaCount); ?>], // Diterima count (fourth bar)
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\ITP\c\bismillah\resources\views/layouts/home_user.blade.php ENDPATH**/ ?>